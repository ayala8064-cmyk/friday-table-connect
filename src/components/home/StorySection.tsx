      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-primary mb-4">הבעיה</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-primary mb-4">הפתרון</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-primary mb-4">ההשפעה</h3>
            <p className="text-muted-foreground leading-relaxed">
