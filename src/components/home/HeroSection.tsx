          ...
          >
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              <div className="absolute inset-8 bg-gradient-to-br from-secondary to-card rounded-full shadow-warm-lg flex items-center justify-center overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&h=600&fit=crop&crop=faces"
                  alt="משפחה וקשיש בארוחת שישי"
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">ארוחות שנוצרו</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
